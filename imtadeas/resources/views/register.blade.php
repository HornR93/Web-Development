<x-layouts.layout>
  ...
  <form action="/register" method="POST" class="bg-gradient-to-b from-zinc-300 via-zinc-100 to-zinc-300 p-8 rounded-xl shadow-lg border border-zinc-200 flex flex-col gap-4 w-1/3">
    <a href="/">
      ...
      @csrf
      <h1 class="text-center text-xl text-zinc-900 font-semibold">Registrovat</h1>
      ...
      <a href="/login" class="text-zinc-900 hover:text-zinc-600">Pokud již máte účet, přihlaste se.</a>
  </form>
