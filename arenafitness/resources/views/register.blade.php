<x-layouts.guest>
    ...
    <form action="/register" method="POST" class="bg-zinc-900 p-8 rounded-xl shadow-lg border border-zinc-200 flex flex-col gap-4 w-1/3">
        <a href="/">
        
            <div class="flex justify-end">
              
              <button type="button" class=" bg-zinc-900 mr-1 pt-1 absolute">
        ...
        @csrf
        <h1 class="text-center text-xl text-teal-500 font-semibold">Registrovat</h1>
        ...
        <a href="/login" class="text-zinc-200">Pokud již máte účet, přihlaste se.</a>
    </form>
